...
export const DEFAULT_COMBINE_QA_PROMPT = PromptTemplate.fromTemplate(qa_template);
...
export const COMBINE_QA_PROMPT_SELECTOR = new ConditionalPromptSelector(DEFAULT_COMBINE_QA_PROMPT, [[isChatModel, CHAT_QA_PROMPT]]);
...
const CHAT_COMBINE_PROMPT = ChatPromptTemplate.fromPromptMessages(combine_messages);
export const COMBINE_PROMPT_SELECTOR = new ConditionalPromptSelector(COMBINE_PROMPT, [[isChatModel, CHAT_COMBINE_PROMPT]]);
