import { BaseChain, LLMChain, loadQAStuffChain, } from "./index.js";
...
export class ChatVectorDBQAChain extends BaseChain {
    ...
    constructor(fields) {
        ...
        this.chatbotId = fields.chatbotId;
    ...
    async _call(values) {
        ...
        const docs = await this.vectorstore.similaritySearch(newQuestion, this.k, this.chatbotId);
        const inputs = {
            question,
    ...
    static fromLLM(llm, vectorstore, chatbotId) {
